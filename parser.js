...
yy: {},
symbols_: {"error":2,"program":3,"s_expression_list":4,"EOF":5,"s_expression":6,"special_form":7,"list":8,"symbol":9,"literal":10,"atom":11,"basic_list":12,"typed_list":13,"hash_map":14,"(":15,"element_list":16,")":17,"[":18,"]":19,"HASH_MAP_START":20,"HASH_MAP_END":21,"element":22,"QUOTE":23,"FUNCTION":24,"NIL":25,"BOOLEAN_TRUE":26,"BOOLEAN_FALSE":27,"STRING":28,"number":29,"DECIMAL_NUMBER":30,"OCTAL_NUMBER":31,"HEXIDECIMAL_NUMBER":32,"IDENTIFIER":33,"$accept":0,"$end":1},
...
case 1: return $$[$0-1]; 
break;
case 2: this.$ = [$$[$0]]; console.log("dbg:", "s_expression_list", this.$); 
break;
case 3: this.$ = $$[$0-1]; this.$.push($$[$0]); console.log("dbg:", "s_expression_list", this.$); 
break;
case 12: this.$ = $$[$0-1]; console.log("dbg:", "list", this.$); 
break;
case 13: this.$ = []; console.log("dbg:", "list", this.$); 
break;
case 14: this.$ = ["typed-list", $$[$0-1]]; console.log("dbg:", "typed_list", this.$); 
break;
case 15: this.$ = ["typed-list", []]; console.log("dbg:", "typed_list", this.$); 
break;
case 16: this.$ = ["hash-map", $$[$0-1]]; console.log("dbg:", "hash_map", this.$); 
break;
case 17: this.$ = ["hash-map", []]; console.log("dbg:", "hash_map", this.$); 
break;
case 18: this.$ = [$$[$0]]; console.log("dbg:", "element_list", this.$); 
break;
case 19: this.$ = $$[$0-1]; this.$.push($$[$0]); console.log("dbg:", "element_list", this.$); 
break;
case 21: this.$ = ["quote", $$[$0]]; 
break;
case 22: this.$ = ["fn", $$[$0-1]]; 
break;
case 23: this.$ = null; console.log("dbg:", "nil", this.$); 
break;
case 24: this.$ = true; console.log("dbg:", "true", this.$); 
break;
case 25: this.$ = false; console.log("dbg:", "false", this.$); 
break;
case 26: this.$ = yytext; "a".replace(/^"/, "").replace(/"$/, ""); console.log("dbg:", "string", this.$); 
break;
case 28: this.$ = Number(yytext, 10); console.log("dbg:", "decimal", this.$); 
break;
case 29: this.$ = parseInt(yytext.replace(/^#/, ''), 8); console.log("dbg:", "octal", this.$); 
break;
case 30: this.$ = parseInt(yytext.replace(/^#/, ''), 16); console.log("dbg:", "hexidecimal", this.$); 
break;
case 31: this.$ = yytext; console.log("dbg:", "ident", this.$); 
break;
}
},
