(function() {
  ...
  oppo.stringify = function(o) {
    ...
    switch(type) {
      case "array":
        return types.List.prototype.toString.call({value:o});
      case "object":
  ...
  macro("quasiquote", function(x) {
    ...
    for(_i = 0, _len = _ref4.length;_i < _len;_i++) {
      ...
      if(item instanceof types.UnquoteSpliced) {
        ...
        if(item instanceof types.Unquoted) {
  ...
  [6, 1], [6, 1], [8, 1], [8, 1], [8, 1], [12, 3], [12, 2], [13, 3], [13, 2], [14, 3], [14, 2], [16, 1], [16, 2], [22, 1], [7, 2], [7, 2], [7, 2], [7, 2], [7, 3], [11, 1], [11, 1], [11, 1], [10, 1], [10, 1], [10, 1], [32, 2], [33, 1], [33, 1], [33, 1], [31, 1], [31, 2], [9, 1]], performAction:function anonymous(yytext, yyleng, yylineno, yy, yystate, $$, _$) {
    ...
    switch(yystate) {
      ...
      case 22:
        ...
        break;
      case 23:
        this.$ = new types.Quasiquoted($$[$0], yy);
        break;
      case 24:
        this.$ = new types.Unquoted($$[$0], yy);
        break;
      case 25:
        this.$ = new types.UnquoteSpliced($$[$0], yy);
        break;
      case 26:
