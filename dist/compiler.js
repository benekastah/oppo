...
(function() {
  ...
  compile_list = function(ls, to_compile) {
    var c_callable, c_ls, callable, callable_is_keyword, callable_is_quoted, callable_is_symbol, result, x;
    if (to_compile == null) {
      to_compile = true;
    }
    if (ls.quoted) {
