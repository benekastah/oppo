(function() {
  var eval, eval_helpers;
  var __slice = Array.prototype.slice, __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };
  eval = null;
  eval_helpers = function(RT) {
    var getAllValues, getValue, recursive_walk, thunk, types, _ref;
    if (eval != null) {
      return eval;
    }
    eval = {};
    ...
    eval.def = function(scope, x, RT) {
      ...
      return types.identifier.def(RT, ident, scope.eval(scope, exp));
    };
    eval.set = function(scope, x, RT) {
      var exp, ident, __;
      __ = x[0], ident = x[1], exp = x[2];
      return types.identifier["set!"](RT, ident, scope.eval(scope, exp));
    };
    ...
    eval.defmacro = function(scope, x) {
      ...
      ret = function() {
        ...
        return scope.eval(scope, toEval);
      };
      ret.is_macro = true;
    ...
    eval["do"] = function(scope, x) {
      var exp, _i, _len, _ref2, _results;
      _ref2 = x.slice(1);
      _results = [];
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        exp = _ref2[_i];
        _results.push(thunk(scope, exp));
      }
      return _results;
    };
    ...
    eval.func_call = function(scope, x, RT) {
      var args, fn, fn_name, i, item, _len;
      fn_name = x[0], args = 2 <= x.length ? __slice.call(x, 1) : [];
      if (typeof (getValue(fn_name)) !== 'function') {
      ...
      if (fn.is_macro) {
        return getValue(fn.apply(scope, args));
      } else {
